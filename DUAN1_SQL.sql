...
SELECT KHACHHANG.IDKH,KHACHHANG.TENKH,KHACHHANG.SDT, HOADONCT.NGAYMUA,SANPHAM.TENSP,HOADONCT.SOLUONG,HOADONCT.DONGIA,HOADONCT.TONGTIEN,HOADONCT.TRANGTHAI
FROM KHACHHANG
JOIN HOADONCT ON KHACHHANG.MAKH = HOADONCT.MAKH JOIN
 SANPHAM ON HOADONCT.MASPCT = SANPHAM.MASP;
