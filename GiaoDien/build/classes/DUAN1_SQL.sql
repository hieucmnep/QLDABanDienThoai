...
-- KHÁCH HÀNG 
-- Inserting data into the KHACHHANG table
INSERT INTO KHACHHANG (MAKH, TENKH, NGAYSINH, GIOITINH, SDT, TRANGTHAI, DIACHI, EMAIL)
VALUES
('KH001', N'Nguyen Van A', '1990-01-15', N'Nam', '0123456789', 1, N'Hanoi', 'nguyenvana@email.com'),
('KH002', N'Tran Thi B', '1985-05-20', N'Nữ', '0987654321', 1, N'Ho Chi Minh', 'tranthib@email.com'),
('KH003', N'Le Van C', '1998-08-10', N'Nam', '0112233445', 0, N'Da Nang', 'levanc@email.com'),
('KH004', N'Pham Van D', '1995-03-25', N'Nam', '0369852147', 1, N'Can Tho', 'phamvand@email.com'),
('KH005', N'Nguyen Thi E', '1980-12-08', N'Nữ', '0999888777', 0, N'Hue', 'nguyenthe@email.com'),
('KH006', N'Tran Van F', '1992-06-30', N'Nam', '0123456780', 1, N'Vinh', 'tranvanf@email.com');
UPDATE KHACHHANG
...
SET TRANGTHAI = 
    ...
    END;
UPDATE KHACHHANG SET MAKH=?,TENKH=?,NGAYSINH=?,GIOITINH,SDT,TRANGTHAI,DIACHI,EMAIL,WHERE MAKH=?
