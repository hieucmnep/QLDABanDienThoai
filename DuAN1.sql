...
SELECT SANPHAM.MASP,TENSP,GIA,NGAYNHAP,SUM(SANPHAMCT.SOLUONG) as TONG
FROM SANPHAMCT JOIN SANPHAM ON SANPHAMCT.MASP = SANPHAM.MASP
where (SANPHAMCT.SOLUONG)  > 70
...
VALUES
('HD001', 'SPCT001','KH001','KM001', 799.99, 2, 1600, 1000, '2023-01-01', N'Tiền mặt', 1599.99, '', '10% ', N'Da Thanh Toan'),
('HD001', 'SPCT002','KH002','KM002', 1299.99, 1, 1300, 0, '2023-01-01', N'Quẹt thẻ ', 1299.99, ' ', '5% ',N'Chua Thanh Toan'),
('HD002', 'SPCT003','KH003','KM001', 299.99, 3, 900, 0, '2023-02-15', N'Chuyển khoản', 899.99, ' ', '15% ',N'Da Thanh Toan'),
('HD002', 'SPCT004','KH004','KM002', 199.99, 1, 200, 0.99, '2023-02-15', N'Thanh toán online', 199.99, '  ', '10%',N'Da Thanh Toan'),
('HD003', 'SPCT005','KH005','KM002', 2499.99, 1, 2500, 0.01, '2023-03-01', N'Chuyển khoản', 2499.99, ' ', '20%',N'Da Thanh Toan');
...
INSERT INTO KHUYENMAI (MAKM, PhanTramGiamGia, SoLuong, NgayBatDau, NgayKetThuc)
VALUES ('KM001', '10', 100, '2023-01-01', '2023-01-31'),
       ('KM002', '20', 50, '2023-02-01', '2023-02-28'),
       ('KM003', '15', 200, '2023-03-01', '2023-03-31');
