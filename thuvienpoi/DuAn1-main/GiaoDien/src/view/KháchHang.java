...
public class KháchHang extends javax.swing.JPanel {
    ...
    private void loadtable() {
        ArrayList<Model.KhachHang> kh2 = khsevice.GetAll();
        model.setRowCount(0);
        for (Model.KhachHang kh : kh2) {
            model.addRow(new Object[]{kh.getId(), kh.getMaKH(), kh.getTenKH(), kh.getNgaySinh(), kh.getGioiTinh(), kh.getSdt(), kh.getEmail(), kh.getDiaChi(), kh.getTrangThai()});
        }
    }
    ...
    private void hienthi() {
        ...
        cbbtrangthai.setSelectedItem(tblbang.getValueAt(idex,4).toString());
    }
